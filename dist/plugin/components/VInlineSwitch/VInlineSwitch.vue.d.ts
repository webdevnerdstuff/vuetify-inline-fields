...
declare const __VLS_component: import('vue').DefineComponent<__VLS_PublicProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {}, string, import('vue').PublicProps, Readonly<__VLS_PublicProps> & Readonly<{}>, {
    falseValue: import('vuetify/components').VSwitch["falseValue"];
    iconFalse: string;
    ...
    icons: boolean;
    trueValue: import('vuetify/components').VSwitch["trueValue"];
    ...
    underlined: boolean;
    valueColor: string;
    density: import('vuetify/components').VSwitch["density"];
